...
const navigation = [
  ...
  { name: "Team", href: "/team", icon: UsersRound, badge: "10 members" },
  { name: "Profile photos", href: "/profile-photos", icon: ImageIcon },
  { name: "Travel", href: "/travel", icon: Plane, badge: "3 missing" },
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 overflow-y-auto p-4">
            <p className="text-xs font-semibold text-muted-foreground mb-3 uppercase tracking-wider">Registration</p>
                  ...
                  <li key={item.name}>
                    <Link
                      ...
                      className={cn(
                        ...
                        isActive ? "bg-[#2f3090]/10 text-[#2f3090]" : "text-gray-700 hover:bg-gray-100",
                      )}
                    >
                      ...
                      {item.badge && (
                        <Badge
                          ...
                          className={cn(
                            "text-xs",
                            item.badge.includes("missing") ? "bg-red-100 text-red-700" : "bg-gray-100",
                          )}
                        >
                          {item.badge}
                        </Badge>
